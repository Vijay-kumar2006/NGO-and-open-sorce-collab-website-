-- CreateEnum
CREATE TYPE "Role" AS ENUM ('NGO', 'CONTRIBUTOR');

-- CreateEnum
CREATE TYPE "ProjectStatus" AS ENUM ('idea', 'active', 'completed');

-- CreateEnum
CREATE TYPE "TaskStatus" AS ENUM ('open', 'assigned', 'review', 'completed');
